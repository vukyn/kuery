...
- [kuery/cache expire-after-ACCESS](memory/kuery-cache-expire-after-access.md) — otter TTL resets on read
...
- [No artifact in pet-platform](memory/no-artifact-in-pet-platform.md) — never call Artifact here; write HTML to disk
- [Pin base to worktree HEAD](memory/pin-comparison-base-to-worktree-head.md) — before/after proof: archive HEAD, not origin/main
- [Review mock before coder port](memory/review-mock-before-coder-port.md) — STOP after designer for user review
