...
// TestHealthHandlerServesUnwrappedReport pins the response shape the endpoint
...
func TestHealthHandlerServesUnwrappedReport(t *testing.T) {
	app := fiber.New()
	app.Get("/__version", Health(pkgHealth.New("github.com/gofiber/fiber/v2")))
