// Package apikey is inbound API-key authentication for Fiber v2: a caller proves
// its identity with a static shared secret sent in a request header.
//
// It is the sibling of the auth package rather than a replacement for it. auth
...
// oversight. Fiber v2 hands out request strings as zero-copy views into fasthttp's
...
// ctx.GetClientIPFromFiberCtx). This package retains nothing request-derived: the
